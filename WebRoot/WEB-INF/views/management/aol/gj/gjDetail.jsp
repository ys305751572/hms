...
<script type="text/javascript"
	src="${contextPath}/resources/js/bootstrap-validation.js"
	charset="UTF-8"></script>
<script type="text/javascript"
	src="${contextPath}/resources/aol/js/uploadPreview.js" charset="UTF-8"></script>
			...
			<div class="row-fluid z-ulnone">
				<div class="box span12">
					<div class="box-header well z-h2">
						<h2>
							<i class="icon-film"></i> 广告信息
						</h2>

						<jsp:include page="/WEB-INF/views/backDiv.jsp" flush="true">
							<jsp:param name="url"
								value="${contextPath}/management/gj/listPage" />
						</jsp:include>
					</div>
					<div class="box-content">
						<form class="form-horizontal" method="post" id="restarteProForm"
							...
							<table>
								<tr>
									<td>
										<div class="control-group">
											...
											<div class="controls_1">${gj.title }</div>
										</div>
									</td>
									<td rowspan="5">
										<div
											...
											<div id="imgDiv">
												<c:if test="${!empty gj.image}">
													<img src="${contextPath}${gj.image}" width="400px"
														height="354px" alt="${gj.image}">
												</c:if>
											</div>
										</div>
									</td>
								...
								<tr>
									<td>
										<div class="control-group">
											...
											<div class="controls_1">${gj.url}</div>
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="control-group">
											<label class="control-label_1" for="title">内容</label>
											<div class="controls_1">${gj.content }</div>
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="control-group">
											<label class="control-label_1" for="title">类型</label>
											<div class="controls_1">
												<c:if test="${gj.type eq 1}">
													公教
												</c:if>
												<c:if test="${gj.type eq 2}">
													展览
												</c:if>
											</div>
										</div>
								...
								<tr>
									<td>
										<div class="control-group">
											<label class="control-label_1" for="title">是否发布</label>
											<div class="controls_1">
												<c:if test="${gj.isList eq -1}">
													已发布
												</c:if>
												<c:if test="${gj.isList eq 1}">
													未发布
